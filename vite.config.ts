...
export default defineConfig({
  // Rutas relativas en vez de absolutas ("/assets/..." -> "./assets/..."):
  // así el build funciona igual sirviéndolo desde la raíz del dominio o
  // desde un subdirectorio como en GitHub Pages
  // (usuario.github.io/nombre-repo/), sin tener que fijar aquí el nombre
